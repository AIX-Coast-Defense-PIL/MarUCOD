...
from yoloUtils.general import coco80_to_coco91_class, check_dataset, check_file, check_img_size, \
...
def test(data,
    ...
    if dataloader[1].stored_preds:
        ...
        for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader[0], desc=s)):
            ...
            for si, pred in enumerate(out):
                ...
                if save_txt:
                    ...
                    for *xyxy, conf, cls in predn.tolist():
                        ...
                        xywh = (torch.tensor(xyxy).view(1, 4).to(torch.int32)).view(-1).tolist()  # normalized xywh
